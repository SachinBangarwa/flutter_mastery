...
class TopicExplanationView extends StatefulWidget {
  final String category;
  final String topicId;
  final TopicContentService contentService;

  const TopicExplanationView({
    super.key,
  ...
  @override
  State<TopicExplanationView> createState() => _TopicExplanationViewState();
}

class _TopicExplanationViewState extends State<TopicExplanationView> {
    ...
    return FutureBuilder<String>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Center(
            child: Text(
              'Error loading explanation content',
        ...
        return SingleChildScrollView(
          ...
          child: MarkdownBody(
            ...
            styleSheet: MarkdownStyleSheet(
              ...
              h3: AppTextStyles.headingMedium(color: AppColors.darkTextPrimary).copyWith(
                fontWeight: FontWeight.bold,
                height: 1.6,
              ),
