...
class TopicInterviewView extends StatefulWidget {
  final String category;
  final String topicId;
  final TopicContentService contentService;

  const TopicInterviewView({
    super.key,
  ...
  @override
  State<TopicInterviewView> createState() => _TopicInterviewViewState();
}

class _TopicInterviewViewState extends State<TopicInterviewView> {
