...
class TopicPracticeView extends StatefulWidget {
  final String category;
  final String topicId;
  final TopicContentService contentService;

  const TopicPracticeView({
    super.key,
  ...
  @override
  State<TopicPracticeView> createState() => _TopicPracticeViewState();
}

class _TopicPracticeViewState extends State<TopicPracticeView> {
    ...
    return FutureBuilder<String>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Center(
            child: Text(
              'Error loading practice exercises',
